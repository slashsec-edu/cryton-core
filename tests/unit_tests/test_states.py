...
class TestStates(TestCase):
    ...
    def test_check_transition_validity(self):
        ...
        ret = machine._check_transition_validity('TEST', 'INVALID')
        self.assertTrue(ret)
    ...
    def test_check_valid_state(self):
        ...
        self.assertIsNone(machine._check_valid_state('TEST', state_list))
    ...
    @patch('cryton.lib.util.states.StateMachine._check_transition_validity')
    ...
    @patch('cryton.lib.util.states.StateMachine._check_valid_state')
