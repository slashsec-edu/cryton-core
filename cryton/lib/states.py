...
RUN_TRANSITIONS = [
    ...
    (PAUSING, TERMINATED), (PAUSED, TERMINATED)
]
...
STAGE_STATES = [
    PENDING, RUNNING, FINISHED, PAUSING, PAUSED, WAITING, TERMINATED
]

STAGE_TRANSITIONS = [
    (PENDING, RUNNING), (RUNNING, FINISHED), (RUNNING, PAUSING), (PAUSING, PAUSED), (PAUSED, RUNNING),
    (PAUSING, FINISHED), (PENDING, WAITING), (WAITING, RUNNING), (PAUSED, WAITING), (WAITING, FINISHED),
    (PENDING, TERMINATED), (RUNNING, TERMINATED), (WAITING, TERMINATED), (PAUSING, TERMINATED), (PAUSED, TERMINATED)
]

STAGE_EXECUTE_STATES = [PENDING, PAUSED, WAITING]
STAGE_SCHEDULE_STATES = [PENDING]
STAGE_UNSCHEDULE_STATES = [PENDING, PAUSED]
STAGE_PAUSE_STATES = [RUNNING]
STAGE_UNPAUSE_STATES = [PAUSED]
STAGE_KILL_STATES = [PENDING, RUNNING, WAITING, PAUSING]

# Step and StepExecution related
STEP_STATES = [
    PENDING, RUNNING, FINISHED, IGNORE, PAUSED, TERMINATED
]

STEP_TRANSITIONS = [
    (PENDING, RUNNING), (PENDING, IGNORE), (RUNNING, FINISHED), (RUNNING, ERROR), (PENDING, ERROR),
    (PENDING, PAUSED), (PAUSED, RUNNING), (RUNNING, TERMINATED)
]
...
# Successor related
VALID_SUCCESSOR_STATES = [FINISHED, TERMINATED]
